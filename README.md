...
subgraph LEGEND[" "]
  ...
  L3["THOUGHT"]:::thought
  L4["TOOL CALL"]:::tool
  L5["GENERATED — new content<br/>(not in the substrate before this call)"]:::gen
  L6["★ gold turn"]:::gold
  L7["… = N more of the same kind"]:::dots
end

Q["<b>Q</b> — &quot;What might John's financial status be?&quot;<br/><i>gold answer: Middle-class or wealthy   ·   gold evidence: D5:5</i>"]:::question
Q --> R0
...
classDef question     fill:#FFFFFF,stroke:#1F1F1F,color:#1F1F1F,stroke-width:1.6px;
