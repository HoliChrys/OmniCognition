...
_ENUM_RE = re.compile(
    r"\b(find all|list (all|every)?|which (tweets|turns|messages|docs|ones|"
    r"items)|all the|every |enumerate|retrieve all|how many|name all|"
    r"give me all)\b", re.IGNORECASE)
